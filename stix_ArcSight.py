...
def extractObservable(args, obs, values):
    ...
    if val:
        ...
        if args[0].strict:
            ...
            print("Encountered unsupported CybOX observable type: " + typ + ", ignoring...", file=sys.stderr)
...
def print_help(parser):
        ...
        print("All indicators and observables in the STIX document(s) will be imported into the specified reference set.\n", file=sys.stderr)
...
def main():
            ...
            for content in response_dict["content_blocks"]:
                ...
                if bindingId and bindingId.startswith("urn:stix.mitre.org:xml"):
                    ...
                    try:
                        ...
                        print("Could not parse STIX document: ", file=sys.stderr)
    ...
    # Import from a XML file on disk
        ...
        print("Invalid arguments. Type 'python stix_Arcsight.py --help' for usage.\n", file=sys.stderr)
